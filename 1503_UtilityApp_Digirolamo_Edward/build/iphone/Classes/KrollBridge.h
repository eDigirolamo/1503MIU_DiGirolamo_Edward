...
@interface k1503_UtilityApp_Digirolamo_EdwardObject : KrollCoverageObject {
#else
@interface k1503_UtilityApp_Digirolamo_EdwardObject : KrollObject {
#endif
@private
...
extern NSString * k1503_UtilityApp_Digirolamo_Edward$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1503_UtilityApp_Digirolamo_EdwardObject *_k1503_utilityapp_digirolamo_edward;
    KrollObject* console;
	BOOL shutdown;
