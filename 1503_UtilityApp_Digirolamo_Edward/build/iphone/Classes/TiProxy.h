...
//Rare exceptions to indicate a bug in the _k1503_utilityapp_digirolamo_edward code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1503_UtilityApp_Digirolamo_Edward proxies.
 */
