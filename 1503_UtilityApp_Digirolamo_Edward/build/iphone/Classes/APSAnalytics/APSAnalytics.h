 ...
 * to send analytic data that can be viewed on the k1503_UtilityApp_Digirolamo_Edward Dashboard.
 *
 * For information on getting started with k1503_UtilityApp_Digirolamo_Edward Platform Services,
