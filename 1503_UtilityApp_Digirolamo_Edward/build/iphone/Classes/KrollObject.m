...
//@interface k1503_UtilityApp_Digirolamo_EdwardObject : NSObject
//@end

@interface k1503_UtilityApp_Digirolamo_EdwardObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1503_UtilityApp_Digirolamo_EdwardObject class]])
		{
			for (NSString *key in [[(k1503_UtilityApp_Digirolamo_EdwardObject*)o modules] allKeys])
			{
