...
-(void)request:(APSHTTPRequest *)request onLoad:(APSHTTPResponse *)response
{
	...
	if ([req cancelled]==NO)
	{
		...
		if (data == nil || [data length]==0)
		{
			...
			NSError *error = [NSError errorWithDomain:@"com.k1503_utilityapp_digirolamo_edward._k1503_utilityapp_digirolamo_edward.imageloader" code:1 userInfo:errorDetail];
