...
/**
 Base class for all k1503_UtilityApp_Digirolamo_Edward views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1503_UtilityApp_Digirolamo_Edward view hierarchy (such as wrapped iOS UIViews) was touched.
