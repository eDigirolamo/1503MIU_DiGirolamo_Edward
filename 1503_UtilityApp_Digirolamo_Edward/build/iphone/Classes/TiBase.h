...
// in simulator we redefine to format for k1503_UtilityApp_Digirolamo_Edward Developer console
...
{\
	NSString * exceptionName = [@"org.k1503_utilityapp_digirolamo_edward." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1503_utilityapp_digirolamo_edward";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemNone = -1, 
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemSpinner = -2,
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemProgressBar = -3,
	
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemSlider = -4,
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemSwitch = -5,
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemMultiButton = -6,
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemSegmented = -7,
	
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemTextView = -8,
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemTextField = -9,
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemSearchBar = -10,
	
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemPicker = -11,
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemDatePicker = -12,
	
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemInfoLight = -13,
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemInfoDark = -14,
	
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemDisclosure = -15,
	
	UIk1503_UtilityApp_Digirolamo_EdwardNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1503_UtilityApp_Digirolamo_Edward instances of
