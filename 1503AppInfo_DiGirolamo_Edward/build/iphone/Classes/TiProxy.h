...
//Rare exceptions to indicate a bug in the _k1503appinfo_digirolamo_edward code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1503AppInfo_DiGirolamo_Edward proxies.
 */
