...
//@interface k1503AppInfo_DiGirolamo_EdwardObject : NSObject
//@end

@interface k1503AppInfo_DiGirolamo_EdwardObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1503AppInfo_DiGirolamo_EdwardObject class]])
		{
			for (NSString *key in [[(k1503AppInfo_DiGirolamo_EdwardObject*)o modules] allKeys])
			{
