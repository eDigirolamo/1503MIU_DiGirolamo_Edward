...
// in simulator we redefine to format for k1503AppInfo_DiGirolamo_Edward Developer console
...
{\
	NSString * exceptionName = [@"org.k1503appinfo_digirolamo_edward." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1503appinfo_digirolamo_edward";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemNone = -1, 
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemSpinner = -2,
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemProgressBar = -3,
	
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemSlider = -4,
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemSwitch = -5,
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemMultiButton = -6,
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemSegmented = -7,
	
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemTextView = -8,
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemTextField = -9,
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemSearchBar = -10,
	
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemPicker = -11,
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemDatePicker = -12,
	
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemInfoLight = -13,
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemInfoDark = -14,
	
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemDisclosure = -15,
	
	UIk1503AppInfo_DiGirolamo_EdwardNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1503AppInfo_DiGirolamo_Edward instances of
