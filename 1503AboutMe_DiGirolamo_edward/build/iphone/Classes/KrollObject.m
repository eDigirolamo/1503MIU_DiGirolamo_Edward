...
//@interface k1503AboutMe_DiGirolamo_edwardObject : NSObject
//@end

@interface k1503AboutMe_DiGirolamo_edwardObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1503AboutMe_DiGirolamo_edwardObject class]])
		{
			for (NSString *key in [[(k1503AboutMe_DiGirolamo_edwardObject*)o modules] allKeys])
			{
