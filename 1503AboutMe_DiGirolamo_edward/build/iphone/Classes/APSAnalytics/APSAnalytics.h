 ...
 * to send analytic data that can be viewed on the k1503AboutMe_DiGirolamo_edward Dashboard.
 *
 * For information on getting started with k1503AboutMe_DiGirolamo_edward Platform Services,
