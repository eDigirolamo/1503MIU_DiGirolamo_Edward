...
// in simulator we redefine to format for k1503AboutMe_DiGirolamo_edward Developer console
...
{\
	NSString * exceptionName = [@"org.k1503aboutme_digirolamo_edward." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1503aboutme_digirolamo_edward";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1503AboutMe_DiGirolamo_edwardNativeItemNone = -1, 
	UIk1503AboutMe_DiGirolamo_edwardNativeItemSpinner = -2,
	UIk1503AboutMe_DiGirolamo_edwardNativeItemProgressBar = -3,
	
	UIk1503AboutMe_DiGirolamo_edwardNativeItemSlider = -4,
	UIk1503AboutMe_DiGirolamo_edwardNativeItemSwitch = -5,
	UIk1503AboutMe_DiGirolamo_edwardNativeItemMultiButton = -6,
	UIk1503AboutMe_DiGirolamo_edwardNativeItemSegmented = -7,
	
	UIk1503AboutMe_DiGirolamo_edwardNativeItemTextView = -8,
	UIk1503AboutMe_DiGirolamo_edwardNativeItemTextField = -9,
	UIk1503AboutMe_DiGirolamo_edwardNativeItemSearchBar = -10,
	
	UIk1503AboutMe_DiGirolamo_edwardNativeItemPicker = -11,
	UIk1503AboutMe_DiGirolamo_edwardNativeItemDatePicker = -12,
	
	UIk1503AboutMe_DiGirolamo_edwardNativeItemInfoLight = -13,
	UIk1503AboutMe_DiGirolamo_edwardNativeItemInfoDark = -14,
	
	UIk1503AboutMe_DiGirolamo_edwardNativeItemDisclosure = -15,
	
	UIk1503AboutMe_DiGirolamo_edwardNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1503AboutMe_DiGirolamo_edward instances of
