...
@interface k1503AboutMe_DiGirolamo_edwardObject : KrollCoverageObject {
#else
@interface k1503AboutMe_DiGirolamo_edwardObject : KrollObject {
#endif
@private
...
extern NSString * k1503AboutMe_DiGirolamo_edward$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1503AboutMe_DiGirolamo_edwardObject *_k1503aboutme_digirolamo_edward;
    KrollObject* console;
	BOOL shutdown;
