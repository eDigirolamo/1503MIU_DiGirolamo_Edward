...
//Rare exceptions to indicate a bug in the _k1503aboutme_digirolamo_edward code (Eg, function that a subclass should have implemented)
...
/**
 The base class for k1503AboutMe_DiGirolamo_edward proxies.
 */
