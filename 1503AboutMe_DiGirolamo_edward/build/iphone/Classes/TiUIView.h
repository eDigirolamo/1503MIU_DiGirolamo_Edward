...
/**
 Base class for all k1503AboutMe_DiGirolamo_edward views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1503AboutMe_DiGirolamo_edward view hierarchy (such as wrapped iOS UIViews) was touched.
