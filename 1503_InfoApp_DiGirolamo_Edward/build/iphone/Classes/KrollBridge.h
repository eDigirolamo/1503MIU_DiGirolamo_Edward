...
@interface k1503AppInfo_DiGirolamo_EdwardObject : KrollCoverageObject {
#else
@interface k1503AppInfo_DiGirolamo_EdwardObject : KrollObject {
#endif
@private
...
extern NSString * k1503AppInfo_DiGirolamo_Edward$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1503AppInfo_DiGirolamo_EdwardObject *_k1503appinfo_digirolamo_edward;
    KrollObject* console;
	BOOL shutdown;
