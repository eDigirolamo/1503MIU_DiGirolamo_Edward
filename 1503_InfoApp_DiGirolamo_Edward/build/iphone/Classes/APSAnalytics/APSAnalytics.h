 ...
 * to send analytic data that can be viewed on the k1503AppInfo_DiGirolamo_Edward Dashboard.
 *
 * For information on getting started with k1503AppInfo_DiGirolamo_Edward Platform Services,
